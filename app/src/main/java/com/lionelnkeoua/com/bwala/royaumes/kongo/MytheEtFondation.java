 ...
 */
public class MytheEtFondation extends Fragment {

    private int textColor;
    private int textSize = 10;

    public MytheEtFondation(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_royaume_kongo_mythe_fondation, container, false);
