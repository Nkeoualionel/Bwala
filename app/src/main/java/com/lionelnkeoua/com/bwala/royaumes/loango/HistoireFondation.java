 ...
 */
public class HistoireFondation extends Fragment {

    private int textColor;
    private int textSize = 10;

    public HistoireFondation(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
       View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_royaume_loango_histoire_fondation, container, false);
