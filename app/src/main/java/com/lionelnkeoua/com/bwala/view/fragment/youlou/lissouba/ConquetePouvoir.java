 ...
 */
public class ConquetePouvoir extends Fragment {

    private int textSize = 10;
    private int textColor;

    public ConquetePouvoir(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_lissouba_conquete_pouvoir, container, false);
