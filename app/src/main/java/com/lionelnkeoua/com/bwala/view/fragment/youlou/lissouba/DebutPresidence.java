 ...
 */
public class DebutPresidence extends Fragment {
    private int textSize = 10;
    private int textColor;

    public DebutPresidence(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_lissouba_debut_presidence, container, false);
        ...
        final TextView mFiveText = (TextView)view.findViewById(R.id.five);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (textSize <=30){
                    ...
                    mFiveText.setTextSize(textSize);
        ...
        fabs.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (textColor == 1){
                    ...
                    mFiveText.setTextColor(Color.BLACK);
                } else {
                    ...
                    mFiveText.setTextColor(Color.GRAY);
                    textColor = 0;
                }
            }
        });
