 ...
 */
public class FinPresidence extends Fragment {
    private int textSize = 10;
    private int textColor;

    public FinPresidence(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_lissouba_fin_presidence, container, false);
