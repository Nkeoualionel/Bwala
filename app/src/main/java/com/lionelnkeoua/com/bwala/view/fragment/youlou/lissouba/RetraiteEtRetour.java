 ...
 */
public class RetraiteEtRetour extends Fragment {

    private int textSize = 10;
    private int textColor;

    public RetraiteEtRetour(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_lissouba_retraite_retour, container,false);
