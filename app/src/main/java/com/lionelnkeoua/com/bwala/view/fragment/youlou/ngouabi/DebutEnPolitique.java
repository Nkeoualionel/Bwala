 ...
 */
public class DebutEnPolitique extends Fragment {
    private int textColor;
    private int textSize = 10;

    public DebutEnPolitique(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_ngouabi_debut_politique, container, false);
