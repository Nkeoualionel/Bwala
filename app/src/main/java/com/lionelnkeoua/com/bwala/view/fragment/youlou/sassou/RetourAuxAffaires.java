...
/**
 * Created by Lionel on 14/04/2018.
 */
public class RetourAuxAffaires extends Fragment {
    private int textSize = 10;
    private int textColor;

    public RetourAuxAffaires(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_sassou_retour_aux_affaires, container, false);
