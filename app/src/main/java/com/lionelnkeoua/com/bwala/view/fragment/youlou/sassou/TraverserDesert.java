...
/**
 * Created by Lionel on 19/03/2018.
 */
public class TraverserDesert extends Fragment{
    private int textColor;
    private int textSize = 10;

    public TraverserDesert(){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_sassou_taverser_desert, container, false);
