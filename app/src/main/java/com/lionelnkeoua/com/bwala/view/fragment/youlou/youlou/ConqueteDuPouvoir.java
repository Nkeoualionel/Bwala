...
/**
 * Created by Lionel on 20/02/2018.
 */
public class ConqueteDuPouvoir extends Fragment {
    private int textSize = 10;
    private int textColor;

    public ConqueteDuPouvoir(){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getContext()).inflate(R.layout.activity_youlou_conquete_pouvoir, container, false);
